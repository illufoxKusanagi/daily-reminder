...
import { DroppableArea } from "@/modules/calendar/dnd/droppable-area";
import { groupEvents } from "@/modules/calendar/helpers";
import type { IEvent } from "@/modules/calendar/interfaces";
import { CalendarTimeline } from "@/modules/calendar/views/week-and-day-view/calendar-time-line";
import { RenderGroupedEvents } from "@/modules/calendar/views/week-and-day-view/render-grouped-events";
import { WeekViewMultiDayEventsRow } from "@/modules/calendar/views/week-and-day-view/week-view-multi-day-events-row";
      ...
      <motion.div className="flex-col sm:flex" variants={staggerContainer}>
        ...
        <ScrollArea className="h-full" type="always">
          <div className="flex">
            {/* Hours column */}
            <motion.div
              className="relative w-12 sm:w-18"
